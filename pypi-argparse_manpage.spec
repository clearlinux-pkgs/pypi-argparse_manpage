...
Version  : 4.1
Release  : 2
URL      : https://files.pythonhosted.org/packages/6c/96/b53e86c3479d03f62338ede7430c32ec9b6bf189c83a5008b7d346dc00af/argparse-manpage-4.1.tar.gz
...
%prep
%setup -q -n argparse-manpage-4.1
cd %{_builddir}/argparse-manpage-4.1
pushd ..
cp -a argparse-manpage-4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681747023
