...
Source0  : https://files.pythonhosted.org/packages/3d/b7/cacb63bd461c83050b3b0efffc9151077b69de900ef5559ffeee72fa825b/argparse-manpage-4.6.tar.gz
...
%prep
%setup -q -n argparse-manpage-4.6
cd %{_builddir}/argparse-manpage-4.6
pushd ..
cp -a argparse-manpage-4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717598353
